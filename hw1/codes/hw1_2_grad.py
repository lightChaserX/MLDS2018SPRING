...
train_history2 = model2.fit(x=X_Train40_norm,  
                          ...
                          epochs=1000, batch_size=300,callbacks=[cbk], verbose=1)
...
#score2 = [i for i in train_history2.history['val_loss']]


#plt.plot(hist1,'r',label='model1')
plt.plot(hist2,'b',label='model2')
#plt.plot(score2,'r',label='test')
#plt.plot(hist3,'b',label='model3')
plt.legend(loc='upper right')
plt.ylabel('loss')
plt.xlabel('epoch')
plt.savefig("fig_loss_mnist_1_2.png")
plt.show()

#hist1 = [i for i in train_history1.history['acc']]
#hist2 = [i for i in train_history2.history['acc']]
#hist3 = [i for i in train_history3.history['acc']]


#plt.plot(hist1,'r',label='model1')
plt.plot(cbk.norms,'b',label='model2')
#plt.plot(hist3,'b',label='model3')
plt.legend(loc='upper right')
plt.ylabel('accuracy')
plt.xlabel('epoch')
plt.savefig("fig_grad_mnist_1_2.png")
plt.show()
